...
function validate() {  
  ...
  { 
    ...
    document.getElementById("message1").innerHTML = "**Password length must be only 8 characters,contain at least one digit, special character,start with capital letter ";}  
 exit(); 
} 
